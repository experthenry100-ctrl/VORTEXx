...
const IMAGE_BANK = {
  mouse: [
    ...
    'https://images.unsplash.com/photo-1603525253816-56a8f154fb4a?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1610484795034-73895eb48833?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1607677686475-ad54538dce26?auto=format&fit=crop&w=600&q=80'
  ],
  keyboard: [
    ...
    'https://images.unsplash.com/photo-1626218174397-5780d006be91?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1566598484642-d204db847eb0?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1568019853965-c96765798034?auto=format&fit=crop&w=600&q=80'
  ],
  headset: [
    'https://images.unsplash.com/photo-1599669454699-248893623440?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1583573636246-18cb2246697f?auto=format&fit=crop&w=600&q=80',
  ...
  monitor: [
    ...
    'https://images.unsplash.com/photo-1527434065445-5120678ebc66?auto=format&fit=crop&w=600&q=80',
  ...
  chair: [
    ...
    'https://images.unsplash.com/photo-1616428469345-534d0b04b61c?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1617364852223-75f57e78dc96?auto=format&fit=crop&w=600&q=80'
  ],
  controller: [
    'https://images.unsplash.com/photo-1592840496694-26d035b52b48?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1600080972464-8e5f35f63d88?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1593118247619-e2d6f056869e?auto=format&fit=crop&w=600&q=80',
  ...
  streaming: [
    ...
    'https://images.unsplash.com/photo-1617781358042-45e0d4734947?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=600&q=80',
    'https://images.unsplash.com/photo-1478737270239-2f02b77ac6d5?auto=format&fit=crop&w=600&q=80'
  ]
};
...
export const getProducts = (): Product[] => {
  // We want to refresh the products to see the CJ changes, so we won't load from cache if it's the old version
  // or we can just overwrite. For this demo, let's overwrite to ensure user sees changes.
  const products = generateProducts();
  localStorage.setItem('vortex_cj_products_v2', JSON.stringify(products));
  return products;
};
